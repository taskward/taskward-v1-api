...
import { ErrorModel, SuccessModel, ValidationModel, JWTUserModel } from '@/interfaces'
...
const handler = async (
  ...
  try {
    ...
    const validationResult: ValidationModel = signupValidation(username, password, confirmPassword)
